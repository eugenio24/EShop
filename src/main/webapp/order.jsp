...
<html>
    ...
    <body>
        ...
        <section>
            ...
            <p>
                <div>Numero Ordine: ${orderHead.orderNumber}</div>
                <div>Data Ordine: ${orderHead.orderDate}</div>
                <div>Totale Ordine: € ${orderHead.totalPrice}</div>
                <div>Indirizzo di Consegna: ${orderHead.shippingAddress}</div>
